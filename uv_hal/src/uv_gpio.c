...
void GPIO_IRQHandler(void) {
	...
	while(LPC_GPIOINT->IO0IntStatF || LPC_GPIOINT->IO0IntStatR) {
		...
		if (LPC_GPIOINT->IO0IntStatF & (1 << i) || LPC_GPIOINT->IO0IntStatR & (1 << i)) {
			if (callback) {
				callback(__uv_get_user_ptr(), (uv_gpios_e) GPIO_PORT_0 + i);
				// clear interrupt on this pin only
	...
	while(LPC_GPIOINT->IO2IntStatF || LPC_GPIOINT->IO2IntStatR) {
		...
		if (LPC_GPIOINT->IO2IntStatF & (1 << i) || LPC_GPIOINT->IO2IntStatR & (1 << i)) {
			if (callback) {
				callback(__uv_get_user_ptr(), (uv_gpios_e) GPIO_PORT_2 + i);
				// clear interrupt on this pin only
...
void uv_gpio_configure(uv_gpios_e gpio, uv_gpio_input_config_e value) {
	...
	uv_gpio_input_config_e table81 = value & (~(GLITCH_FILTER_ENABLED));
	// hysteresis is not supported
	uv_gpio_input_config_e table83 = value & (~(HYSTERESIS_ENABLED));
	// digital mode
	table83 |= (1 << 7);
	...
	uv_gpio_input_config_e table85 = 0;
	if (table85);
	// I2C modes not set in GPIO config
	uv_gpio_input_config_e table87 = value & (~(SLEW_CONTROL_DISABLED | GLITCH_FILTER_ENABLED));
	if (table87);
	// table 89 has all available configurations
	// bit 7 has to be 1 for normal operation
	uv_gpio_input_config_e table89 = value | (1 << 7);
	if (table89);

	switch (gpio) {
#if (CONFIG_PORT0 | CONFIG_PIO0_12)
	case PIO0_12: *__uv_gpio_get_iocon(gpio) = table83; break;
#endif
#if (CONFIG_PORT0 | CONFIG_PIO0_13)
	case PIO0_13: *__uv_gpio_get_iocon(gpio) = table83; break;
#endif
#if (CONFIG_PORT0 | CONFIG_PIO0_23)
	case PIO0_23: *__uv_gpio_get_iocon(gpio) = table83; break;
#endif
#if (CONFIG_PORT0 | CONFIG_PIO0_24)
	case PIO0_24: *__uv_gpio_get_iocon(gpio) = table83; break;
#endif
#if (CONFIG_PORT0 | CONFIG_PIO0_25)
	case PIO0_25: *__uv_gpio_get_iocon(gpio) = table83; break;
#endif
#if (CONFIG_PORT0 | CONFIG_PIO0_26)
	case PIO0_26: *__uv_gpio_get_iocon(gpio) = table83; break;
#endif
#if (CONFIG_PORT1 | CONFIG_PIO1_30)
	case PIO1_30: *__uv_gpio_get_iocon(gpio) = table83; break;
#endif
#if (CONFIG_PORT1 | CONFIG_PIO1_31)
	case PIO1_31: *__uv_gpio_get_iocon(gpio) = table83; break;
#endif
#if (CONFIG_PORT0 | CONFIG_PIO0_29)
	case PIO0_29: *__uv_gpio_get_iocon(gpio) = table85; break;
#endif
#if (CONFIG_PORT0 | CONFIG_PIO0_30)
	case PIO0_30: *__uv_gpio_get_iocon(gpio) = table85; break;
#endif
#if (CONFIG_PORT0 | CONFIG_PIO0_31)
	case PIO0_31: *__uv_gpio_get_iocon(gpio) = table85; break;
#endif
#if (CONFIG_PORT0 | CONFIG_PIO0_27)
	case PIO0_27: *__uv_gpio_get_iocon(gpio) = table87; break;
#endif
#if (CONFIG_PORT0 | CONFIG_PIO0_28)
	case PIO0_28: *__uv_gpio_get_iocon(gpio) = table87; break;
#endif
#if (CONFIG_PORT5 | CONFIG_PIO5_2)
	case PIO5_2: *__uv_gpio_get_iocon(gpio) = table87; break;
#endif
#if (CONFIG_PORT5 | CONFIG_PIO5_3)
	case PIO5_3: *__uv_gpio_get_iocon(gpio) = table87; break;
#endif
#if (CONFIG_PORT0 | CONFIG_PIO0_7)
	case PIO0_7: *__uv_gpio_get_iocon(gpio) = table89; break;
#endif
#if (CONFIG_PORT0 | CONFIG_PIO0_8)
	case PIO0_8: *__uv_gpio_get_iocon(gpio) = table89; break;
#endif
#if (CONFIG_PORT0 | CONFIG_PIO0_9)
	case PIO0_9: *__uv_gpio_get_iocon(gpio) = table89; break;
#endif
#if (CONFIG_PORT1 | CONFIG_PIO1_5)
	case PIO1_5: *__uv_gpio_get_iocon(gpio) = table89; break;
#endif
#if (CONFIG_PORT1 | CONFIG_PIO1_6)
	case PIO1_6: *__uv_gpio_get_iocon(gpio) = table89; break;
#endif
#if (CONFIG_PORT1 | CONFIG_PIO1_7)
	case PIO1_7: *__uv_gpio_get_iocon(gpio) = table89; break;
#endif
#if (CONFIG_PORT1 | CONFIG_PIO1_14)
	case PIO1_14: *__uv_gpio_get_iocon(gpio) = table89; break;
#endif
#if (CONFIG_PORT1 | CONFIG_PIO1_16)
	case PIO1_16: *__uv_gpio_get_iocon(gpio) = table89; break;
#endif
#if (CONFIG_PORT1 | CONFIG_PIO1_17)
	case PIO1_17: *__uv_gpio_get_iocon(gpio) = table89; break;
#endif
	default: *__uv_gpio_get_iocon(gpio) = table81; break;
	}
#endif
}
static LPC_GPIO_TypeDef* get_port(uv_gpios_e gpio) {
