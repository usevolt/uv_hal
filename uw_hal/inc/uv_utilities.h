...
#define M_REPEAT1_2ARGS(X, ARG1, ARG2) X(0, ARG1, ARG2)
#define M_REPEAT2_2ARGS(X, ARG1, ARG2) M_REPEAT1_2ARGS(X, ARG1, ARG2) X(1, ARG1, ARG2)
#define M_REPEAT3_2ARGS(X, ARG1, ARG2) M_REPEAT2_2ARGS(X, ARG1, ARG2) X(2, ARG1, ARG2)
#define M_REPEAT4_2ARGS(X, ARG1, ARG2) M_REPEAT3_2ARGS(X, ARG1, ARG2) X(3, ARG1, ARG2)
#define M_REPEAT5_2ARGS(X, ARG1, ARG2) M_REPEAT4_2ARGS(X, ARG1, ARG2) X(4, ARG1, ARG2)
#define M_REPEAT6_2ARGS(X, ARG1, ARG2) M_REPEAT5_2ARGS(X, ARG1, ARG2) X(5, ARG1, ARG2)
#define M_REPEAT7_2ARGS(X, ARG1, ARG2) M_REPEAT6_2ARGS(X, ARG1, ARG2) X(6, ARG1, ARG2)
#define M_REPEAT8_2ARGS(X, ARG1, ARG2) M_REPEAT7_2ARGS(X, ARG1, ARG2) X(7, ARG1, ARG2)
#define M_REPEAT9_2ARGS(X, ARG1, ARG2) M_REPEAT8_2ARGS(X, ARG1, ARG2) X(8, ARG1, ARG2)
#define M_REPEAT10_2ARGS(X, ARG1, ARG2) M_REPEAT9_2ARGS(X, ARG1, ARG2) X(9, ARG1, ARG2)
#define M_REPEAT11_2ARGS(X, ARG1, ARG2) M_REPEAT10_2ARGS(X, ARG1, ARG2) X(10, ARG1, ARG2)
#define M_REPEAT12_2ARGS(X, ARG1, ARG2) M_REPEAT11_2ARGS(X, ARG1, ARG2) X(11, ARG1, ARG2)
#define M_REPEAT13_2ARGS(X, ARG1, ARG2) M_REPEAT12_2ARGS(X, ARG1, ARG2) X(12, ARG1, ARG2)
#define M_REPEAT14_2ARGS(X, ARG1, ARG2) M_REPEAT13_2ARGS(X, ARG1, ARG2) X(13, ARG1, ARG2)
#define M_REPEAT15_2ARGS(X, ARG1, ARG2) M_REPEAT14_2ARGS(X, ARG1, ARG2) X(14, ARG1, ARG2)
#define M_REPEAT16_2ARGS(X, ARG1, ARG2) M_REPEAT15_2ARGS(X, ARG1, ARG2) X(15, ARG1, ARG2)
#define M_REPEAT17_2ARGS(X, ARG1, ARG2) M_REPEAT16_2ARGS(X, ARG1, ARG2) X(16, ARG1, ARG2)
#define M_REPEAT18_2ARGS(X, ARG1, ARG2) M_REPEAT17_2ARGS(X, ARG1, ARG2) X(17, ARG1, ARG2)
#define M_REPEAT19_2ARGS(X, ARG1, ARG2) M_REPEAT18_2ARGS(X, ARG1, ARG2) X(18, ARG1, ARG2)
#define M_REPEAT20_2ARGS(X, ARG1, ARG2) M_REPEAT19_2ARGS X(19, ARG1, ARG2)

/// @brief: Repeat macro with an argument. The argument is given to the
/// repeated function. The function should take two arguments, first the index and next the argument.
#define REPEAT_2ARGS(count, func, arg1, arg2)		CAT2(M_REPEAT, CAT2(count, _2ARGS(func, arg1, arg2)))
#define REPEAT_2ARGS2(count, func, arg1, arg2)		CAT3(M_REPEAT, CAT3(count, _2ARGS(func, arg1, arg2)))
#define REPEAT_2ARGS3(count, func, arg1, arg2)		CAT4(M_REPEAT, CAT3(count, _2ARGS(func, arg1, arg2)))
#define REPEAT_2ARGS4(count, func, arg1, arg2)		CAT5(M_REPEAT, CAT3(count, _2ARGS(func, arg1, arg2)))
