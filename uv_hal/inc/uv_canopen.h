...
#endif
#if !defined(CONFIG_CANOPEN_EXMEM_INDEX)
#define CONFIG_CANOPEN_EXMEM_INDEX				0x5FFD
#define CONFIG_CANOPEN_EXMEM_DATA_SUBINDEX		0
#define CONFIG_CANOPEN_EXMEM_OFFSET_SUBINDEX	1
#define CONFIG_CANOPEN_EXMEM_FILENAME_SUBINDEX	2
#define CONFIG_CANOPEN_EXMEM_FILESIZE_SUBINDEX	3
#define CONFIG_CANOPEN_EXMEM_WRITEREQ_SUBINDEX	4
#define CONFIG_CANOPEN_EXMEM_CLEARREQ_SUBINDEX	5
#endif
#if CONFIG_TERMINAL
